...
static const _EncoderCounts_type_support_symbol_names_t _EncoderCounts_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo2axis_data_strcs, msg, EncoderCounts)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo2axis_data_strcs, msg, EncoderCounts)),
  }
};
...
{
  return &::robo2axis_data_strcs::msg::rosidl_typesupport_cpp::EncoderCounts_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robo2axis_data_strcs, msg, EncoderCounts)() {
  return get_message_type_support_handle<robo2axis_data_strcs::msg::EncoderCounts>();
}
