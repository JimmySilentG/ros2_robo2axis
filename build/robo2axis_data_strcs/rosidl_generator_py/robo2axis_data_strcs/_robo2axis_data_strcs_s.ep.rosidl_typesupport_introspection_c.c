...
static void * robo2axis_data_strcs__msg__duty_cycle__create_ros_message(void)
{
  return robo2axis_data_strcs__msg__DutyCycle__create();
}

static void robo2axis_data_strcs__msg__duty_cycle__destroy_ros_message(void * raw_ros_message)
{
  robo2axis_data_strcs__msg__DutyCycle * ros_message = (robo2axis_data_strcs__msg__DutyCycle *)raw_ros_message;
  robo2axis_data_strcs__msg__DutyCycle__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool robo2axis_data_strcs__msg__duty_cycle__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * robo2axis_data_strcs__msg__duty_cycle__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(robo2axis_data_strcs, msg, DutyCycle);
...
_register_msg_type__msg__duty_cycle(PyObject * pymodule)
{
  ...
  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&robo2axis_data_strcs__msg__duty_cycle__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&robo2axis_data_strcs__msg__duty_cycle__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&robo2axis_data_strcs__msg__duty_cycle__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&robo2axis_data_strcs__msg__duty_cycle__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(robo2axis_data_strcs, msg, DutyCycle),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
...
PyMODINIT_FUNC
PyInit_robo2axis_data_strcs_s__rosidl_typesupport_introspection_c(void)
{
