...
bool robo2axis_data_strcs__msg__duty_cycle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robo2axis_data_strcs.msg._duty_cycle.DutyCycle", full_classname_dest, 46) == 0);
  }
  robo2axis_data_strcs__msg__DutyCycle * ros_message = _ros_message;
  {  // dcpercent
    PyObject * field = PyObject_GetAttrString(_pymsg, "dcpercent");
    if (!field) {
      return false;
    }
...
PyObject * robo2axis_data_strcs__msg__duty_cycle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robo2axis_data_strcs.msg._duty_cycle");
