...
#include "robo2axis_data_strcs/msg/detail/duty_cycle__rosidl_typesupport_fastrtps_c.h"
...
using _DutyCycle__ros_msg_type = robo2axis_data_strcs__msg__DutyCycle;
...
size_t get_serialized_size_robo2axis_data_strcs__msg__DutyCycle(
  const void * untyped_ros_message,
...
static uint32_t _DutyCycle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robo2axis_data_strcs__msg__DutyCycle(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robo2axis_data_strcs
size_t max_serialized_size_robo2axis_data_strcs__msg__DutyCycle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robo2axis_data_strcs__msg__DutyCycle;
    is_plain =
      (
...
static size_t _DutyCycle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robo2axis_data_strcs__msg__DutyCycle(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo2axis_data_strcs, msg, DutyCycle)() {
